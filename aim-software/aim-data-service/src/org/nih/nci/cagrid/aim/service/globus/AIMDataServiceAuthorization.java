 ...
 * 
 */
public class AIMDataServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://aim.cagrid.nci.nih.org/AIMDataService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public AIMDataServiceAuthorization() {
	}
