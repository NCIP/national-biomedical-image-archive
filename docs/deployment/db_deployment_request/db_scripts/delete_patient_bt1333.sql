...
create temporary table study_temp as select study_pk_id from study where patient_pk_id=1341096003;
...
delete p1
from patient p1 where p1.patient_pk_id = 1341096003;
...
create table patient_temp as   
  ...
  where s.patient_pk_id = p.patient_pk_id and p.trial_dp_pk_id = 1341063168;

update patient
set visibility = '1'
where trial_dp_pk_id = 1341063168;
