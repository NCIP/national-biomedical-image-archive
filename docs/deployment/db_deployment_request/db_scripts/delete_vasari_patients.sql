...
create temporary table study_temp as select study_pk_id from study where patient_pk_id in (1337589906,1337589912,1337589926);
...
delete p1
from patient p1 where p1.patient_pk_id in (1337589906,1337589912,1337589926);
