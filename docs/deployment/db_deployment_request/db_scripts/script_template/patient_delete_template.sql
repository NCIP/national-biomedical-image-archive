...
create temporary table study_temp as select study_pk_id from study where patient_pk_id=***PATIENT_PK_ID***;
...
delete p1
from patient p1 where p1.patient_pk_id = ****PATIENT_PK_ID****;
