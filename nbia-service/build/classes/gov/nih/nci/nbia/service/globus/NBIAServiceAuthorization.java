...
public class NBIAServiceAuthorization implements PDP {
	...
	public void authorizeExecuteEnumerationQuery(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			return true;
		} else if(operation.getLocalPart().equals("executeEnumerationQuery")){
			authorizeExecuteEnumerationQuery(peerSubject, context, operation);
			return true;
