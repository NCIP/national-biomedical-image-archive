...
public class GeneralSeriesSubDoc  implements Serializable
{
	/**
	...
	**/
	...
	private GeneralEquipmentSubDoc generalEquipment;
	/**
	* Retreives the value of generalEquipment attribue
	* @return generalEquipment
	**/

	public GeneralEquipmentSubDoc getGeneralEquipment(){
		return generalEquipment;
	}
	/**
	...
	**/
	...
	public void setGeneralEquipment(GeneralEquipmentSubDoc generalEquipment){
	...
	**/
	...
	{
		if(obj instanceof GeneralSeriesSubDoc)
		{
			GeneralSeriesSubDoc c =(GeneralSeriesSubDoc)obj;
	...
	**/
	...
	private List annotationContents;
	public List getAnnotationContents() {
		return annotationContents;
	}

	public void setAnnotationContents(List annotationContents) {
