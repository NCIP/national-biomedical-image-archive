...
public class ClinicalTrial  implements Serializable
{
	...
	**/
	...
	private Collection<TrialSite> siteCollection;
	/**
	* Retreives the value of siteCollection attribue
	* @return siteCollection
	**/

	public Collection<TrialSite> getSiteCollection(){
		return siteCollection;
	}
	...
	**/
	...
	public void setSiteCollection(Collection<TrialSite> siteCollection){
	...
	**/
	...
	{
		if(obj instanceof ClinicalTrial) 
		{
			ClinicalTrial c =(ClinicalTrial)obj; 			 
