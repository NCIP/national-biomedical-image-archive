...
package enumeration.data.cagrid.nci.nih.gov.EnumerationDataService.types;
...
public class EnumerationDataServiceReference  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://gov.nih.nci.cagrid.data.enumeration/EnumerationDataService/types", ">EnumerationDataServiceReference"));
