...
public class TransferQueryResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the transferServiceContextReference value for this TransferQueryResponse.
     * 
    ...
    /**
     * Sets the transferServiceContextReference value for this TransferQueryResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TransferQueryResponse)) return false;
        TransferQueryResponse other = (TransferQueryResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TransferQueryResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://gov.nih.nci.cagrid.data.transfer/TransferDataService", ">TransferQueryResponse"));
