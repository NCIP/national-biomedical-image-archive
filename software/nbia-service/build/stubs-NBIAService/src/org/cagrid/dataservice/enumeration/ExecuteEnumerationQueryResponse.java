/**
 * ExecuteEnumerationQueryResponse.java
 *
...
public class ExecuteEnumerationQueryResponse  implements java.io.Serializable {
    private gov.nih.nci.cagrid.enumeration.stubs.response.EnumerationResponseContainer enumerationResponseContainer;

    public ExecuteEnumerationQueryResponse() {
    }
    ...
    /**
     * Gets the enumerationResponseContainer value for this ExecuteEnumerationQueryResponse.
     * 
    ...
    /**
     * Sets the enumerationResponseContainer value for this ExecuteEnumerationQueryResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExecuteEnumerationQueryResponse)) return false;
        ExecuteEnumerationQueryResponse other = (ExecuteEnumerationQueryResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExecuteEnumerationQueryResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://org.cagrid.dataservice.enumeration/Cql2EnumerationDataService", ">ExecuteEnumerationQueryResponse"));
