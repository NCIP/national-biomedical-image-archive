 ...
 * 
 */
public abstract class NBIAServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(NBIAServiceResourceBase.class);

	private NBIAServiceResourceConfiguration configuration;
    ...
    public NBIAServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((NBIAServiceResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(NBIAServiceConstants.DOMAINMODEL);
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((NBIAServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(NBIAServiceConstants.SERVICEMETADATA);
	...
	public org.cagrid.dataservice.cql.support.QueryLanguageSupport getQueryLanguageSupport(){
		return ((NBIAServiceResourceProperties) getResourceBean()).getQueryLanguageSupport();
	}
	...
	public void setQueryLanguageSupport(org.cagrid.dataservice.cql.support.QueryLanguageSupport queryLanguageSupport ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(NBIAServiceConstants.QUERYLANGUAGESUPPORT);
	...
	public NBIAServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (NBIAServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadDomainModelFromFile() {
      if(getDomainModel()==null){
		try {
			...
			((NBIAServiceResourceProperties) this.getResourceBean()).setDomainModel((gov.nih.nci.cagrid.metadata.dataservice.DomainModel) Utils.deserializeDocument(dataFile.getAbsolutePath(),
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((NBIAServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
