...
public class PatientAccessDAO {
    ...
    // Seriously unfortunate that for some reason hibernate would not keep a single transaction accross methods even
	...
	public PatientDocument getPatientDocument(String patientId)
	{
		...
		returnValue=fillInStudies(returnValue, patient);
